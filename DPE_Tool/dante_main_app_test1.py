...
ADMIN_USERS = ['shouvik.d.das@in.pwc.com', 'shouvik.d.das@pwc.com',
               ...
               'debolina.b.dutta@in.pwc.com','debolina.b.dutta@pwc.com'
              ]
...
class DPEInboxClearing:
    ...
    def createmenubar(self):
        try:
            ...
            self.reporting_menu.add_command(
                label="Form data for Marketing Consent", command=self.predefined_report_from_dpe_1)
            # self.reporting_menu.add_command(
    ...
    def predefined_report_from_dpe_1(self):
        try:
            if self.report_generated:
                self.reset_all()
    ...
    # def qualtrics(self):
    #     try:
    #         QualtricsReporting(self.master)
    #     except:
    #         logger.error("Below Exception occured: ", exc_info=True)               
    ...
    def showinformation(self):
        try:
            ...
            Creator: Shouvik Das, Manger of PwC India Pvt.Ltd.
            Collaborator: Debolina Dutta,Aman Pratiush - Senior Associate of PwC India Pvt.Ltd.
            Created Date: {VERSION_INFO.get("CreatedDate", "10-10-2020")}
            Last Updated: {VERSION_INFO.get("LastUpdatedOn", "25-08-2024")}
            '''
                    ...
                    if select_wf_status:
                        ...
                        for i, each_payload in enumerate(all_payloads):
                            ...
                            if output_status >= 200 and output_status < 207:
                                table_values = (each_payload, "Completed")
                                ...
                                table_values = (each_payload, "Exception")
                                self.insert_into_table(i, table_values)
                                self.retrieve_data_count_label.config(
                                    text="Current: "+str(i+1), fg="black")
                                ...
                                table_values = (
                                    each_payload, "Error - "+str(output_status))
                                self.insert_into_table(i, table_values)
                                self.retrieve_data_count_label.config(
                                    text="Current: "+str(i+1), fg="black")
                ...
                if is_validated:
                    ...
                    if self.var_selected_source.get() == "Enter Payload (Comma Seperated)":
                        ...
                        for i in range(len(payload_for_unlock)):
                          ...
                          if lockowner_output!="Page Is Not Locked" and lockowner_output!="Page Not Found" and lockowner_output!="Incorrect Page Path" and lockowner_output!="Incorrect UserName/Password":
...
# Start of Form Data for Marketing Consent 
class FormDataforMarketingConsent:
    def __init__(self, master):
        ...
        master.withdraw()
        self.predefined_report_ui.title(
            APPLICATION_NAME + " - " + "Fetch Form Data for Marketing Consent"
        )
        self.predefined_report_ui.geometry("900x800+30+30")
        self.brandpic = PhotoImage(file=BRAND_PIC_FILE)
        self.predefined_report_ui.brandpic = PhotoImage(
    ...
    def validate_input(self, uname, passwd, ip_or_url, environment, selected_form, terr_or_path, props):
        try:
            is_validated = False
            ...
            logger.debug("Is Not Empty Username: %s, Is Not Empty Password: %s, Is Not Empty IP or URL: %s, \
                    Is Not Empty Environment: %s, Is Not Empty Report: %s, Is Not Empty Terr or Path: %s, \
                        Is Not Empty Property: %s, Is Valid IP or URL: %s, Is Selected Report is Valid: %s, "
                         % (is_not_empty_uname, is_not_empty_passwd, is_not_empty_ip_or_url, is_not_empty_environment,
                            is_not_empty_selected_form, is_not_empty_terr_or_path, is_not_empty_props, is_valid_ip_or_url, is_form_selected))

            error_list = []

            if (is_not_empty_environment and is_not_empty_ip_or_url and is_not_empty_passwd
                and is_not_empty_props and is_not_empty_selected_form and is_not_empty_terr_or_path
    ...
    def retreive_data(self):
        try:
            ...
            #is_validated_data=True
             ...
             #uname, passwd,ip_or_url, environment, selected_rep, terr_or_path, props
            is_validated_data = self.validate_input(
                _user_name, _password, _environment_url, _selected_env, _selected_form, _territory_or_path, _selected_property)
            ...
            if is_validated_data:
                ...
                #retrieve
                if continue_operation:
                    self.predefined_report_instance = FormDataMarketingConsent(
                        _environment_url, _user_name, _password)
                    #_fetched_data = self.predefined_report_instance.form_selector(form_name=_selected_form, environment= _selected_env,territory=_territory_or_path, props=_selected_property)
...
# End of Form Data for Marketing Consent ...
